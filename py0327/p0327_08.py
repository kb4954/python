...
# 문자열 - '',""
fruit = ['사과','배','딸기','포도'] # 순서대로 ㅇ, 1, 2, 3 ...
# 내부적으로는 4개의 공간을 만들고 시작하는 주소값을 fruit에 넣음 나중에 카피할 시 주의 잘못 카피하면 다 동일값을 가짐
...
item = [{"galContentId":"3479214","galContentTypeId":"17","galTitle":"통영 중앙전통시장","galWebImageUrl":"http://tong.visitkorea.or.kr/cms2/website/14/3479214.jpg","galCreatedtime":"20250219140831","galModifiedtime":"20250219141444","galPhotographyMonth":"202412","galPhotographyLocation":"경상남도 통영시 중앙동","galPhotographer":"한국관광공사 김지호","galSearchKeyword":"통영 중앙전통시장, 경상남도 통영시, 상설시장"}
